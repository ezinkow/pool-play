const { MlbEntries, Users } = require("../../models");
...
module.exports = function (app) {
    ...
    app.get("/api/mlb/entries/me", async (req, res) => {
        return res.json({ exists: true, entry_name: "Admin View", picks: [] });
    });

    // POST /api/mlb/entries/create
    app.post("/api/mlb/entries/create", requireAuth, async (req, res) => {
        try {
