...
export default function NflPickemAtsStandings() {
    ...
    return (
        <PoolGatekeeper user={currentUser} gameKey="nfl_pickem_ats" className='page-content'>
                        ...
                        return (
                            <div key={u.user_id} style={{
                                ...
                                <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", borderTop: "1px solid #f1f5f9", paddingTop: "8px", fontSize: "12px", color: "#6b7280" }}>
                                    ...
                                    <div>
                                        Best Bets: <span style={{ color: "#047857", fontWeight: 700 }}>{u.best_bet_wins || 0}</span>-<span style={{ color: NFL_RED, fontWeight: 700 }}>{u.best_bet_losses || 0}</span>
                                    </div>
                                </div>
                            </div>
                        );
