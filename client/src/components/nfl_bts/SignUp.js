...
export default function NflBtsSignUp() {
    ...
    useEffect(() => {
        if (!loading && !user) navigate("/nflbts");
    ...
    useEffect(() => {
        ...
        async function checkEntry() {
            try {
                ...
                const { data } = await axios.get("/api/nfl_bts/entries/me", {
        ...
        <div style={{ maxWidth: "800px", margin: "0 auto", paddingLeft: "8px", paddingRight: "8px" }}>
            <div style={{ maxWidth: 480, margin: "0 auto", padding: "40px 16px" }}>
                ...
                <div style={{
                    ...
                    {alreadyIn && (
                        <div>
                            ...
                            <button
                                onClick={() => navigate("/nfl_bts/picks")}
                                style={{
                    ...
                    {!alreadyIn && !success && (
                        <form onSubmit={handleSubmit}>
                            ...
                            >
                                {submitting ? "Processing Entry…" : "Enter NFL Beat The Spread Pool"}
                            </button>
                        </form>
                    )}
                </div>
                ...
                <p style={{ textAlign: "center", marginTop: 20, fontSize: 14, color: "#6b7280" }}>
                    <Link to="/nflbts" style={{ color: NAVY, fontWeight: 600 }}>← Back to NFL Beat The Spread Home</Link>
                </p>
            </div>
        </div>
    );
