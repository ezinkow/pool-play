    ...
    useEffect(() => {
        ...
        async function checkEntry() {
            try {
                ...
                const { data } = await axios.get("/api/nfl/entries/me", {
        ...
        <div  style={{ background: "#f4f7f9", minHeight: "100vh" }}>
            <div style={{ maxWidth: 480, margin: "0 auto", padding: "40px 16px" }}>
                ...
                <p style={{ textAlign: "center", marginTop: 20, fontSize: 14, color: "#6b7280" }}>
                    <Link to="/nfl" style={{ color: NAVY, fontWeight: 600 }}>← Back to NFL home</Link>
                </p>
            </div>
        </div>
    );
